using PromethiumMod.proItems.Weapons;
...
{
	public class PromethiumJavelinProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Promethium Javelin");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			// Drop a javelin item, 28% chance
			int item =
				Main.rand.Next(28) == 0
					? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<PromethiumJavelin>())
					: 0;
		...
		public override void AI()
		{
			...
			if (!isStickingToTarget)
			{
				...
				{
					Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, mod.DustType<Dusts.PromethiumDust>(),
