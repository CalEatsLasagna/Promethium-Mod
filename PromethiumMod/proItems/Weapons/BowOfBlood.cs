...
{
	public class BowOfBlood : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Has a chance to shoot a bonus arrow.");
		}
				...
				public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				Vector2 perturbedSpeed = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(7)); // 10 degree spread.
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "CarniumBar", 8);
